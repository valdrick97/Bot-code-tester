...
async function submitToGoogleForm(employeeId, confirmationNumber) {
    const FORM_URL = "https://docs.google.com/forms/d/e/1FAIpQLSf.../formResponse"; // Replace with your form URL
    const EMPLOYEE_ID_ENTRY = "entry.123456789"; // Replace with actual entry ID for Employee ID
    const CONFIRMATION_NUMBER_ENTRY = "entry.987654321"; // Replace with actual entry ID for Confirmation Number
